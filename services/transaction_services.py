...
class TransactionService():
    ...
    def initiate_transaction_process(self, account_id: int, amount: Decimal, transaction_type_name: str, to_account_id: int=None) -> None:
        ...
        if transaction_type_name == "transfer":
            ...
            self.process_transaction(from_account, amount, transaction_type)

    def process_transaction(self, target_account: Account, amount: Decimal, transaction_type: TransactionTypes) -> None:
